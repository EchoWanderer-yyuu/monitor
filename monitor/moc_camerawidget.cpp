...
QT_MOC_LITERAL(4, 29, 10) // "fetchFrame"

    },
    "CameraWidget\0logMessage\0\0msg\0fetchFrame"
};
...
void CameraWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraWidget::logMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CameraWidget::logMessage(const QString & _t1)
{
